...
private:
    ...
    distancePose calculateGlobalPosition(const std::vector<DistanceSensor>& active_sensors,
                                         double heading_deg,
                                         double current_x,
                                         double current_y);
...
public:
     ...
     * @param odom Reference to the encoder EKF odometry object.
     ...
     */
    DistanceReset(const std::vector<DistanceSensor>& robot_sensors,
